...
The trend is that Pay an Invoice requisition every year has decreased. Paying an invoice requisition decline is a great for the purchasing department. The reason we want departments to move away from paying an invoice requisition is first is Bidding Requirements. By not establishing a purchase order in advance, public bidding requirements are not being met up front.  Second is Contract Terms & Authority. By not establishing a purchase order in advance, there are no contract terms governing the purchase and the individual placing the business likely does not have the authority to do so. Purchasing always prioritized departments on using other requisition type for example good and services and technology based on their needs to get a purchase order generated and pay an invoice requisition type should always be used after the purchase order has been generated and only to pay an invoice.
...
July is the busiest because of the new fiscal year. So, departments create requisitions for a purchase order to be issued for a contract to be made with the supplier so the departments can pay the supplier invoices later using a pay an invoice requisition. Because of the high dollar amount, the majority of the requisitions will route to purchasing for approvals. August and September are the second highest because departments transition from generating purchase orders to suppliers creating invoices and departments need to pay the invoices and for the fall school year. All other months vary depending on the department’s needs.

In total amounts for all requisitions per month, July is still the highest because of the new fiscal year. The second highest is in January for the spring school year. The lowest amount is in November because departments are trying to pay the invoices in which they are of low dollar amount. Requisitions get routed to purchasing based on the dollar amount, if the department uses federal funds in which requires more documentation and paperwork, the supplier since some suppliers that have contracts with ASU that has catalog that will not route to us, and if the invoice from purchase orders needs to get paid using a pay an invoice requisition. All other months vary depending on the department’s needs.


## What is the Total Number of Requisitions per year since 2018 ?


<img width="832" alt="Total Number of all Requisitions per year since 2018" src="https://github.com/user-attachments/assets/4b4df40e-daee-42b4-a6a8-5eb23411a95a">
...
<img width="827" alt="Total Amount of all Requisitions per year since 2018" src="https://github.com/user-attachments/assets/5d7c7c35-ef3e-44a3-9b76-b8c5b426c87e">
...
Since there is no pandemic now, I believe ASU will increase the enrollment. More enrollment means more tuition means more money, meaning departments must purchase things that will go to the purchasing team that will keep us busy. I predict that more requisitions will be processed in 2024 than this year 2023. I believe there will be more Purchase Orders issued in 2024 than 2023. I also believe that departments will spend even more money on Goods/Services, Scientific, Technology, and Construction purchases. I predict every year purchases will increase but more slowly overall.
